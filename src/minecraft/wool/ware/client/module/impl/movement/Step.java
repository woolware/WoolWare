...
import wool.ware.client.event.impl.player.StepEvent;
...
public class Step extends Module {
    ...
    public void onStep(StepEvent event) {
        if (getMc().theWorld == null || getMc().thePlayer == null || Wool.INSTANCE.getModuleManager().getModule("speed").isEnabled() || Wool.INSTANCE.getModuleManager().getModule("flight").isEnabled() || Wool.INSTANCE.getModuleManager().getModule("longjump").isEnabled())
            return;
