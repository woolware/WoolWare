...
public class AutoLogin extends Module {
    public AutoLogin() {
        super("AutoLogin", Category.OTHER, new Color(0xFF91B4).getRGB());
    }
    
    public void onEnable() {
    	this.mc.thePlayer.sendChatMessage("/login 7Iu9WT1YjO");
    	Printer.print("Logged In With A Password: §c7Iu9WT1YjO");
    	toggle();
