package wool.ware.client.config;
...
public class ConfigManager {
    ...
    public void deleteConfig(String cfgname) {
        ...
        Wool.INSTANCE.getConfigManager().getConfigs().remove(getConfig(cfgname));
    }
    ...
    public void saveConfig(String cfgname, boolean key) {
        ...
        Wool.INSTANCE.getModuleManager().getModuleMap().values().forEach(module -> {
    ...
    public void loadConfig(String cfgname) {
        ...
        try {
            ...
            arr.forEach(element -> {
                ...
                Module m = Wool.INSTANCE.getModuleManager().getModule(name);
                if (m != null) {
                    m.load(subobj);
                }
            });
