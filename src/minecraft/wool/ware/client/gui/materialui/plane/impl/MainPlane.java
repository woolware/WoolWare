package wool.ware.client.gui.materialui.plane.impl;
...
import wool.ware.client.gui.materialui.component.impl.CategoryComponent;
import wool.ware.client.gui.materialui.plane.Plane;
...
public class MainPlane extends Plane {
    ...
    public void onDrawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.clickGuiTitleFont.drawStringWithShadow(StringUtils.capitalize(getSelectedCategory().name().toLowerCase()) + " (" + Wool.INSTANCE.getModuleManager().getModulesInCategory(getSelectedCategory()).size() + ")", getPosX() + 45, getPosY() + 24, new Color(229, 229, 223, 255).getRGB());
