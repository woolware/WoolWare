package wool.ware.client.gui.tab;

import net.minecraft.client.gui.ScaledResolution;
import wool.ware.client.Wool;
import wool.ware.client.gui.tab.component.Component;
import wool.ware.client.gui.tab.component.impl.CategoryComponent;
    ...
    public void onKeyPress(int key) {
        ...
        switch (key) {
            ...
            case Keyboard.KEY_RIGHT:
                if (!isExtendedModule() && !isExtendedValue() && !Wool.INSTANCE.getModuleManager().getModulesInCategory(selectedCategory).isEmpty()) setExtendedModule(true);
                break;
            default:
                break;
        }
