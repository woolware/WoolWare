package wool.ware.client.gui.account.gui;
...
import wool.ware.client.gui.account.gui.impl.GuiAddAlt;
import wool.ware.client.gui.account.gui.impl.GuiAltLogin;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_){
        ...
        drawCenteredString(mc.fontRendererObj, "Accounts: " + Wool.INSTANCE.getAccountManager().getAccounts().size(), width / 2, 15, 0xFFFFFFFF);
    }
            ...
            case 5:
                ...
                if(returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    for(String line : Files.readAllLines(Paths.get(chooser.getSelectedFile().getPath()))){
                        ...
                        Wool.INSTANCE.getAccountManager().getAccounts().add(account);
                    }
                }
                ...
                break;
            case 8:
                if(Wool.INSTANCE.getAccountManager().getLastAlt() == null)
                    return;
                loginThread = new AccountLoginThread(Wool.INSTANCE.getAccountManager().getLastAlt().getEmail(),Wool.INSTANCE.getAccountManager().getLastAlt().getPassword());
                loginThread.start();
                break;
            case 9:
                if (Wool.INSTANCE.getAccountManager().getAccounts().isEmpty()) return;
                Wool.INSTANCE.getAccountManager().getAccounts().clear();
                break;
        }
    }
