package wool.ware.client.gui.account.gui.components;
...
public class GuiAccountList extends GuiSlot {
    ...
    @Override
    public int getSize(){
        return Wool.INSTANCE.getAccountManager().getAccounts().size();
    }
    ...
    public Account getAccount(int i){
        return  Wool.INSTANCE.getAccountManager().getAccounts().get(i);
    }
    ...
    public void removeSelected(){
        ...
        Wool.INSTANCE.getAccountManager().getAccounts().remove(getAccount(selected));
