...
public class GuiAlteningLogin extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            case -1:
                ...
                Wool.INSTANCE.getAccountManager().setAlteningKey(key.getText());
                Wool.INSTANCE.getAccountManager().setLastAlteningAlt(token.getText());
            ...
            case 2:
                ...
                break;
            case 3:
                if (key.getText().isEmpty() || Wool.INSTANCE.getAccountManager().getLastAlteningAlt() == null) return;
                Wool.INSTANCE.getAccountManager().setAlteningKey(key.getText());
                thread = new AccountLoginThread(Wool.INSTANCE.getAccountManager().getLastAlteningAlt().replaceAll(" ", ""), "ohareware");
                thread.run();
                Wool.INSTANCE.getAccountManager().save();
                break;
        }
    ...
    public void initGui() {
        ...
        if (Wool.INSTANCE.getAccountManager().getAlteningKey() != null)
            key.setText(Wool.INSTANCE.getAccountManager().getAlteningKey());
