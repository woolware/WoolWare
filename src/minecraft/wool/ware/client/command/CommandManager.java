package wool.ware.client.command;
...
import wool.ware.client.command.impl.*;
...
import wool.ware.client.utils.value.impl.StringValue;
...
public class CommandManager {
    ...
    public void dispatch(final String s) {
        ...
        if (command.length > 1) {
            Module m = Wool.INSTANCE.getModuleManager().getModule(command[0]);
            if (m != null) {
        ...
        Wool.INSTANCE.getCommandManager().getCommandMap().values().forEach(c -> {
