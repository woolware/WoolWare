package wool.ware.client.notification;
...
public class Notification {
    ...
    public void draw(float prevY) {
        HUD hud = (HUD) Wool.INSTANCE.getModuleManager().getModule("hud");
        ...
        if (delete()) Wool.INSTANCE.getNotificationManager().getNotifications().remove(this);
    }
