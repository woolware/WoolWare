...
import wool.ware.client.event.impl.game.WorldLoadEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void clickMouse() {
    	Wool.INSTANCE.getEventBus().dispatch(new ClickMouseEvent());
    ...
    public void runTick() throws IOException {
    	Wool.INSTANCE.getEventBus().dispatch(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    Wool.INSTANCE.getEventBus().dispatch(eventMouse);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                	Wool.INSTANCE.getEventBus().dispatch(new KeyInputEvent(k));
                    KeyBinding.onTick(k);
                }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            Wool.INSTANCE.getEventBus().dispatch(eventWorldLoad);
        } else {
