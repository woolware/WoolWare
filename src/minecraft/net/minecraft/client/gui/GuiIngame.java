...
import wool.ware.client.event.impl.render.CrosshairEvent;
import wool.ware.client.event.impl.render.Render2DEvent;
import wool.ware.client.module.Module;
import wool.ware.client.module.impl.other.AutoMatchJoin;
...
public class GuiIngame extends Gui {
    ...
    protected boolean showCrosshair() {
        ...
        Wool.INSTANCE.getEventBus().dispatch(crosshairEvent);
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        float y1 = 24;
        for (Module mod : Wool.INSTANCE.getModuleManager().getModuleMap().values()) {
        ...
        for (Object score1 : arraylist1) {
            ...
            AutoMatchJoin autoMatchJoin = (AutoMatchJoin) Wool.INSTANCE.getModuleManager().getModule("AutoMatchJoin");
