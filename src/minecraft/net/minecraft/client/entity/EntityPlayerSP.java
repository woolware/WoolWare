...
import wool.ware.client.event.impl.game.ChatEvent;
import wool.ware.client.event.impl.player.MotionEvent;
import wool.ware.client.event.impl.player.PushEvent;
import wool.ware.client.event.impl.player.SlowdownEvent;
import wool.ware.client.event.impl.player.UpdateEvent;
import wool.ware.client.event.impl.render.InsideBlockRenderEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                Wool.INSTANCE.getEventBus().dispatch(updateEvent);
                if (updateEvent.isCanceled()) {
                	Wool.INSTANCE.getEventBus().dispatch(new UpdateEvent(this.rotationYaw, this.rotationPitch, this.getEntityBoundingBox().minY, this.onGround));
                    return;
                }
    ...
    public void sendChatMessage(String message) {
        ...
        Wool.INSTANCE.getEventBus().dispatch(chatEvent);
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        Wool.INSTANCE.getEventBus().dispatch(insideBlockRenderEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Wool.INSTANCE.getEventBus().dispatch(ep);
        if (this.noClip || ep.isCanceled()) {
            ...
            Wool.INSTANCE.getEventBus().dispatch(epo);
            return false;
        }
    }
