...
import wool.ware.client.module.impl.combat.Criticals;
import wool.ware.client.module.impl.other.Animation;
import wool.ware.client.module.impl.visuals.Chams;
import wool.ware.client.module.impl.visuals.SmallItems;
...
public class ItemRenderer
{
	...
	
    {
        ...
        final EntityPlayerSP var31b = this.mc.thePlayer;
        final float var4b = var31b.getSwingProgress(partialTicks);
        final EntityPlayerSP var3b = this.mc.thePlayer;
        final float var41b = var3b.getSwingProgress(partialTicks);
        this.func_178109_a(entityplayersp);
        final float f61 = MathHelper.sin((float)(MathHelper.sqrt_float(var4b) * 3.1));
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        ...
                        if (Wool.INSTANCE.getModuleManager().getModule("animation").isEnabled()) {
                            final Animation animation = ((Animation)Wool.INSTANCE.getModuleManager().getModule("animation"));
                            switch (animation.Mode.getValue()) {
                                ...
                                case REMIX:
                                    ...
                                    this.func_178103_d();
                                    GL11.glRotatef(-var91 * (float) 50.0 / 2.0f, -8.0f, 0.4f, 9.0f);
                                    GL11.glRotatef(-var91 * (float) 40, 1.5f, -0.4f, -0.0f);
                                    break;
                                    
                                case EXHIBITION:
                					this.transformFirstPersonItem(f / 2.0F, 0.0F);
                                    GL11.glRotatef(-var91 * 40.0F / 2.0F, var91 / 2.0F, -0.0F, 9.0F);
                                    GL11.glRotatef(-var91 * 30.0F, 1.0F, var91 / 2.0F, -0.0F);
                                    this.func_178103_d();
                                    break;
                                    
                                case SIGMA:
          						  this.transformFirstPersonItem(var2 * 0.5f, -2.0f);
                                    GlStateManager.rotate(-f61 * 55.0f / 2.0f, -8.0f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-f61 * 45.0f, 1.0f, f61 / 2.0f, -0.0f);
                                    this.func_178103_d();
                                ...
                                case EXHIBITION2:
                                    ...
                                    GL11.glRotated(-var91 * 30.0F, var91 / 2, 0.0F, 9.0F);
                                    GL11.glRotated(-var91 * 50.0F, 0.8F, var91 / 2, 0F);
                                    this.func_178103_d();
                                    break;
                                ...
                                case TAP:
                                    ...
                                    GL11.glRotatef(var91 * 50.0F / 9.0F, -var91, 0.0F, 90.0F);
                                    GL11.glRotatef(var91 * 50.0F, 1.0F, -var91 / 2.0F, 0.0F);
                                    this.func_178103_d();
                                    break;
                                ...
                                case BLUE:
                                	if (itemToRender.getItem() instanceof ItemSword) {
                                        float f6 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 3.1));
                                        GL11.glTranslated(0.5D, 0.6D, -0.7D);
                                        this.transformFirstPersonItem(f / 6, 0.5F);
                                        GlStateManager.rotate(-f6 * 75.0F / 4.5F, f6 / 3.0F, -2.4F, 5.0F);
                                        GlStateManager.rotate(-f6 * 75.0F, 1.5F, f6 / 3.0F, -0.0F);
                                        GlStateManager.rotate(f6 * 72.5F / 2.25F, f6 / 3.0F, -2.7F, 5.0F);
                                        this.func_178103_d();
            ...
            if (Wool.INSTANCE.getModuleManager().getModuleClass(Chams.class).isEnabled() && chams.hands.isEnabled()&& chams.colored.isEnabled()) {
                GL11.glDisable(3008);
                GL11.glDisable(3553);
                GL11.glDisable(2896);
                GL11.glEnable(3042);
