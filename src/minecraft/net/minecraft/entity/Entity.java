...
import wool.ware.client.event.impl.player.SafewalkEvent;
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                Wool.INSTANCE.getEventBus().dispatch(entityStepEvent);
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                	...
                	Wool.INSTANCE.getEventBus().dispatch( new StepEvent(this));
                }
            }
