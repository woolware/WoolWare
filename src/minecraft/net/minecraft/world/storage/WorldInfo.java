...
import wool.ware.client.module.impl.other.TimeChanger;
...
public class WorldInfo
{
    ...
    {
        return  Wool.INSTANCE.getModuleManager().getModule("timechanger").isEnabled() ? ((TimeChanger) Wool.INSTANCE.getModuleManager().getModule("timechanger")).time.getValue():worldTime;
    }
