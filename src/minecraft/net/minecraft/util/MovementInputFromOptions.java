...
import wool.ware.client.module.impl.movement.Scaffold;
...
public class MovementInputFromOptions extends MovementInput {
    ...
    public void updatePlayerMoveState() {
        if (Wool.INSTANCE.getModuleManager().getModule("invwalk").isEnabled() && !(Minecraft.getMinecraft().currentScreen instanceof GuiChat)) {
            ...
            final Scaffold scaffold = (Scaffold) Wool.INSTANCE.getModuleManager().getModule("scaffold");
